        ...
        stage('Init') {
            ...
            steps {
                ...
                script {
                    ...
                    env.DEPLOY_HEALTH_URL = "http://${env.DEPLOY_IP}:${env.DEPLOY_APP_PORT}/actuator/health"
